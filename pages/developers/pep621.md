...
<div class="skhep-bar d-flex m-2" style="justify-content:center;">
  <button class="skhep-bar-item btn m-2 btn-purple" onclick="openTab('hatch')" id='hatch-btn'>Hatch</button>
...
[Whey info here](https://whey.readthedocs.io/en/latest/configuration.html#tconf-tool.whey.additional-files).
...
tooling, even if it can do that using it's own tooling. So make sure you list
